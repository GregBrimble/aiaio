...
- **a mobile application** using Expo and React Native;
...
1. Update `./package.json`:
   ...
   - Update the `homepage` to the application's production URL (e.g. `"https://example.com/"`).
   ...
   ```jsonc
   {
   	...
   	"homepage": "https://example.com/", // <-- update the `homepage`
   	"...": "...",
   	"aiaio": {
