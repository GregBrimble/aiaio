...
This directory contains modules which are shared either privately within this project (e.g. between the web application, CLI and Raycast extension) or publicly on npm.
